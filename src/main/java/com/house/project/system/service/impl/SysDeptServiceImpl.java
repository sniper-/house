...
public class SysDeptServiceImpl implements ISysDeptService
{
    ...
    @Override
    public Long selectServiceProviderId(Long userId) {
        return deptMapper.selectServiceProviderId(userId);
    }
     ...
     */
    @Override
    public List<SysDept> selectOneTwoDept() {
        return deptMapper.selectOneTwoDept();
    }
