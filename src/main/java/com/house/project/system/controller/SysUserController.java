...
public class SysUserController extends BaseController
{
     ...
     */
    @ApiOperation("查询渠道专员")
    @GetMapping(value = "/queryChannelSysUser")
    public AjaxResult queryChannelSysUser()
    {
        return AjaxResult.success(userService.selectUserByRoleKey(Constants.CHANNEL_SYS_USER));
    }
    ...
    public AjaxResult getInfo(@PathVariable(value = "userId", required = false) Long userId)
    {
        ...
        startPage();
        ajax.put("roles", user.isAdmin() ? roleService.selectRoleList(new SysRole()) : roleService.selectRoleList(role));
