...
public class SysDeptController extends BaseController
{
     ...
     * @return 结果
     */
    @ApiOperation("获取所有服务商")
    @GetMapping("/provider")
    public AjaxResult provider()
    {
        return AjaxResult.success(deptService.selectOneTwoDept());
    }
    ...
    private void deptQueryParam(SysDept dept) {
        SysUser user = SecurityUtils.getLoginUser().getUser();
        dept.setDeptId(user.getDeptId());
        dept.setLocalDept(true);
    }
