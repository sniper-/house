...
public class SecurityUtils
{
    /**
     * 获取url域名
     * @param httpServletRequest javax.servlet.http.HttpServlet
     * @return 返回url
     */
    public static String getHttpUrl(HttpServletRequest httpServletRequest) {
        String path = httpServletRequest.getRequestURL().toString();
        return StringUtils.strSplitValue(path, "/", 1);
    }
